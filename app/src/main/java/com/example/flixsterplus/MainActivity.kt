...
private const val NEW_MOVIES = "https://api.themoviedb.org/3/movie/upcoming?api_key=a07e22bc18f5cb106bfe4cc1f83ad8ed"
class MainActivity : AppCompatActivity() {
    private val movies = mutableListOf<Movie>()
    private val newMovies = mutableListOf<UpComingMovie>()
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)
        val rvMovies = findViewById<RecyclerView>(R.id.rvMovies)
        val rvNew = findViewById<RecyclerView>(R.id.rvNewMovies)
        ...
        val newMovieAdapter = UpcomingAdapter(this,newMovies)
        rvNew.adapter = newMovieAdapter
        rvNew.layoutManager = LinearLayoutManager(this)
        client.get(NEW_MOVIES, object : JsonHttpResponseHandler(){
            override fun onFailure(
                statusCode: Int,
                headers: Headers?,
                response: String?,
            ...
            override fun onSuccess(statusCode: Int, headers: Headers?, json: JSON) {
                ...
                try {
                    ...
                    newMovies.addAll(UpComingMovie.fromJsonArrayUp(movieJSONArrayUpcoming))
